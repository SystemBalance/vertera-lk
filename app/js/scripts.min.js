...
$(document).ready(function () {
  ...
  $('a').click(function (e) {
    ...
    $('[id^="jq-page-"]').removeClass('is-active'); // Скрываем открытую боковую панель
  ...
  $(document).stop(true).on('click', '.jq-togglePanel', function (e) {
    ...
    var dataPanel = $(this).attr('data-panel'); // Обработчик для любой кнопки закрытия в панели
  ...
  $('body').on('change', '#deliveryType', function (e) {
    if ($(this).val() == 2) {
      ...
      var cost = parseFloat($('#preTotalCost').data('full-cost')) - parseFloat($(this).data('delivery-cost'));
      ...
      var _cost = parseFloat($('#preTotalCost').data('full-cost'));

      $('#preTotalCost').text(_cost.toLocaleString() + " ₽");
      $('#totalCost').text(_cost.toLocaleString() + " ₽");
    }
  }); // --------------------------------------------------
