...
$(document).ready(function () {
  ...
  function format(data) {
    return '<div class="details-container">' + '<table width="100%" cellpadding="0" cellspacing="0" border="0" class="details-table">' + '<thead>' + '<tr class="fz-xs ttu ls c-medium-grey">' + '<th class="title">Назначение</th>' + '</tr>' + '</thead>' + '<tbody>' + '<tr>' + '<td>' + data.nested.text + '</td>' + '</tr>' + '</tbody>' + '</table>' + '</div>';
  }
